...
* [Ansible Vault](http://docs.ansible.com/ansible/playbooks_vault.html) - Manage and store secrets in Git/Mercurial. Ca be used in a ansible playbook or standalone.
