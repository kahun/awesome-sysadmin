...
* [Bacula](http://blog.bacula.org/) - Another Client-server model backup tool.
...
* [Gradle](https://gradle.org/) - Another open source build automation system.
...
* [OpenNebula](https://opennebula.org/) - An user-driven cloud management platform for sysadmins and devops.
...
* [The Foreman](https://theforeman.org/) - Foreman is a complete lifecycle management tool for physical and virtual servers. FOSS.
...
* [consul](https://www.consul.io/) - It is a tool for discovering and configuring services in your infrastructure.
* [doozerd](https://github.com/ha/doozerd) - Doozer is a highly-available, completely consistent store for small amounts of extremely important data.
* [etcd](https://github.com/coreos/etcd) - A highly-available key value store for shared configuration and service discovery.
* [Juju](https://jujucharms.com/) - Cloud orechestration tool which manages services as charms, YAML configuration and deployment script bundles.
...
* [Salt](https://www.saltstack.com/) - Fast, scalable and flexible systems management software written in Python/ZeroMQ.
* [serf](https://www.serf.io/) - Serf is a tool for cluster membership.
...
* [Seafile](https://www.seafile.com/) - Another Open Source Cloud Storage solution.
...
* [Phabricator](https://www.phacility.com/) - Code review tool build by facebook and used by WikiMedia, FB, dropbox etc. Comes with an integrated wiki, bug tracker, VC integration and a CLI tool called arcanist.
...
* [Citadel/UX](http://www.citadel.orgdoku.php) - Collaboration suite (messaging and groupware) that is descended from the Citadel family of programs.
* [EGroupware](http://www.egroupware.org/en/) - Groupware software written in PHP.
* [Horde Groupware](https://www.horde.org/apps/groupware) - PHP based collaborative software suite that includes email, calendars, wikis, time tracking and file management.
...
* [iTop](https://www.combodo.com/-Overview-.html) - Complete open source, ITIL, web based service management tool.
...
* [Ansible](https://www.ansible.com/) -  It's written in Python and manages the nodes over SSH.
...
* [Slaughter](https://steve.fi/Software/slaughter/) - It's written in Perl.
...
* [GitLab CI](https://gitlab.com/gitlab-ci/) - Based off of ruby. They also provide GitLab, which manages git repositories.
* [Go](https://www.gocd.org/) - Open source continuous delivery server.
* [Jenkins](https://jenkins-ci.org/) - An extendable open source continuous integration server.
...
* [Vlad the Deployer](http://rubyhitsquad.com) - Deployment automation (rake based).
...
* [DRBD](http://docs.linbit.com) - Distributed Replicated Block Device.
...
* [GlusterFS](http://gluster.org/) - Scale-out network-attached storage file system.
* [HDFS](http://hadoop.apache.org/) - Distributed, scalable, and portable file-system written in Java for the Hadoop framework.
* [Lustre](http://lustre.org/) -  A type of parallel distributed file system, generally used for large-scale cluster computing.
* [MooseFS](http://moosefs.org/) - Fault tolerant, network distributed file system.
* [MogileFS](http://code.google.com/p/mogilefs/) - Application level, network distributed file system.
...
* [GLPI](http://glpi-project.org/spip.php?lang=en) - Information Resource-Manager with an additional Administration Interface.
* [OCS Inventory NG](https://www.ocsinventory-ng.org/en/) - Enables users to inventory their IT assets.
...
* [OpenDJ](https://backstage.forgerock.com/docs/dj) - Fork of OpenDS.
* [OpenDS](http://www.oracle.com/splash/java.net/maintenance/index.html) - Another directory server written in Java.
...
* [Cyrus IMAP/POP3](https://www.cyrusimap.org/) - Intended to be run on sealed servers, where normal users are not permitted to log in.
* [Dovecot](https://www.dovecot.org/) - IMAP and POP3 server written primarily with security in mind.
* [Qpopper](https://www.mozilla.org/en-US/thunderbird/) - One of the oldest and most popular server implementations of POP3.
...
* [MailCatcher](https://mailcatcher.me/) - Ruby gem that deploys a simply SMTP MTA gateway that accepts all mail and displays in web interface. Useful for debugging or development.
...
* [Sendmail](https://www.sendmail.com/sm/open_source/) - Message transfer agent (MTA).
...
* [Metronome IM](https://www.lightwitch.org/metronome) - Fork of Prosody IM.
...
* [Icinga](https://www.icinga.com/) - Fork of Nagios.
...
* [Opsview](https://opsview.com/solutions/core) - Based on Nagios 4, Opsview Core is ideal for small IT and test environments.
* [Riemann](http://riemann.io/) - Flexible and fast events processor allowing complex events/metrics analysis.
* [Sensu](https://sensuapp.org/) - Open source monitoring framework.
* [Sentry](https://getsentry.com/welcome/) - Application monitoring, event logging and aggregation.
...
* [Zabbix](https://www.zabbix.com/) - Enterprise-class software for monitoring of networks and applications.
* [Zenoss](http://www.zenoss.org/) - Application, server, and network management platform based on Zope.
...
* [InfluxDB](https://influxdb.com/) - Open source distributed time series database with no external dependencies.
...
* [NOC Project](https://kb.nocproject.org/display/SITE/NOC) - Scalable, high-performance and open-source [OSS](https://en.wikipedia.org/wiki/Operations_support_system) system for ISP, service and content providers.
...
* [rConfig](https://www.rconfig.com/) - Another network device configuration management tool.
...
*Document Store.*
  ...
  * [RavenDB](https://ravendb.net/) - Document based database with ACID/Transactional features.
  * [RethinkDB](https://rethinkdb.com/) - Open source distributed document store database, focuses on JSON.

*Graph.*

  * [FlockDB](https://github.com/twitter-archive/flockdb) - Twitter's distributed, fault-tolerant graph database.
  * [Neo4j](http://neo4j.com/) - Open source graph database.

*Key-Value.*

  * [Couchbase](https://www.couchbase.com/) - In-memory, replicated, peristent key/value datastore.
  ...
  * [Riak](http://basho.com/products/) - Another fault-tolerant key-value NoSQL database.
...
* [Glastopf](http://mushmush.org/) - A low-interaction web application honeypot to emulate vulnerabilities and gather attack data.
...
* [OSSEC](http://ossec.github.io) - OSSEC is a HIDS that performs log analysis, FIM, rootkit detection, and much more.
...
* [Piwik](https://piwik.org/) - Web analytics application.
...
* [Cerb](http://cerb.ai/) - Group-based e-mail management project.
...
* [OTRS](https://www.otrs.com/) - Trouble ticket system for assigning tickets to incoming queries and tracking further communications.
...
* [Trinity Rescue Kit](http://trinityhome.org/Home/index.php?content=TRINITY_RESCUE_KIT____CPR_FOR_YOUR_COMPUTER&front_id=12&lang=en&locale=en) - Linux Live CD for general computer troubleshooting.
...
* [GitBucket](https://github.com/gitbucket/gitbucket) Clone of GitHub written in Scala; single jar install.
* [GitLab](https://gitlab.com/) - Clone of GitHub written in Ruby.
...
* [Fossil](http://www.fossil-scm.org/index.html/doc/trunk/www/index.wiki) - Distributed version control with built-in wiki and bug tracking.
* [Git](https://git-scm.com/) - Distributed revision control and source code management (SCM) with an emphasis on speed.
* [GNU Bazaar](http://bazaar.canonical.com/en/) - Distributed revision control system sponsored by Canonical.
...
* [Proxmox VE](https://www.proxmox.com/en/proxmox-ve) - Complete open source virtualization management solution.
...
* [Xen](https://www.xenproject.org/) - Virtual machine monitor for 32/64 bit Intel / AMD (IA 64) and PowerPC 970 architectures.

## VPN

*VPN software.*

* [OpenVPN](https://community.openvpn.net/openvpn) - Uses a custom security protocol that utilizes SSL/TLS for key exchange.
...
* [DevOpsGuys](https://www.devopsguys.com/blog/) - Devops consultants who blog about operations.
...
* [The Phoenix Project: A Novel about IT, DevOps, and Helping Your Business Win](http://www.itrevolution.com/book/the-phoenix-project/) - How DevOps techniques can fix the problems that happen in IT organizations.
...
* [Dotdeb](https://dotdeb.org/) - Repository with LAMP updated packages for Debian.
...
* [Software Collections](https://www.softwarecollections.org/en/) - Community Release of [Red Hat Software Collections](https://access.redhat.com/documentation/en/red-hat-software-collections/). Provides updated packages of Ruby, Python, etc. for CentOS/Scientific Linux 6.x.

## Websites

*Useful sysadmin related websites.*

* [Ops School](http://www.opsschool.org/en/latest/) - Comprehensive program that will help you learn to be an operations engineer.
